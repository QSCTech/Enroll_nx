...
async function loadConfig() {
  ...
  if (config.config && config.config.enableDataExpirationReminders) {
    globalConfig.enableDataExpirationReminders =
      config.config.enableDataExpirationReminders;
...
document
  .getElementById("enable-data-expiration-reminders")
  .addEventListener("change", handleDataExpirationReminders);
